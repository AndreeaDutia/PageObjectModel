...
public class StaleElementExceptionExample extends BaseTest{
	...
	public void staleExample() throws InterruptedException {
		...
		//fixul pentru StaleElement este reidentificarea elementului care a ramas asociat cu vechea sesiune dinainte de refresh
		element = driver.findElement(By.name("order by"));
